...
int peek(struct stack *sp,int i){
  ...
  if(arrayInd < 0){
    printf("not a valid positin for stack:\n");
    return -1;
  }
  else{
...
int main(){
  ...
  // finding topmost and bottomost element 
  printf("value of  topmost element in stack is %d:\n ",stackTop(sp));
  printf("value of  bottomost  element in stack is %d:\n ",stackBottom(sp));
  return 0;
}